<?php $__env->startSection('title', 'Create Supplier - ' . config('app.name')); ?>
<?php $__env->startSection('page-title', 'Create Supplier'); ?>
...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="<?php echo e(route('suppliers.index')); ?>" class="btn btn-outline-secondary btn-sm">
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('name')); ?>" placeholder="e.g. ABC Supplier" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="mobile_no" id="mobile_no" class="form-control <?php $__errorArgs = ['mobile_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('mobile_no')); ?>" placeholder="e.g. +8801712345678" required>
...
unset($__errorArgs, $__bag); ?>"
                                value="<?php echo e(old('email')); ?>" placeholder="supplier@example.com">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Downloads\supplier-purchase-app\supplier-purchase-app\resources\views/suppliers/create.blade.php ENDPATH**/ ?>