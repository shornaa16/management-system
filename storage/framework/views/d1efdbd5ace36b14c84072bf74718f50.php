...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            <a href="<?php echo e(route('products.create')); ?>" class="btn btn-purple me-2">
                ...
                <tbody>
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($product->code ?? '5100000001'); ?></td>
                            <td><?php echo e($product->brand->name ?? 'Artisan'); ?></td>
                            <td><?php echo e($product->category->name ?? 'Clothing'); ?></td>
                            <td><?php echo e($product->name); ?></td>
                            <td><?php echo e($product->unit ?? 'Pcs'); ?></td>
                            <td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Downloads\supplier-purchase-app\supplier-purchase-app\resources\views/products/index.blade.php ENDPATH**/ ?>