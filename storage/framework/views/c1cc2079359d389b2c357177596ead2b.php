        ...
        <div class="col-md-8">
            <div class="card card-custom p-3 shadow-sm">
                        ...
                        <select id="product_select" class="form-select">
                            ...
                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($product->id); ?>" 
                                        ...
                                        data-brand="<?php echo e($product->brand->name ?? 'Artisan'); ?>"
                                        data-category="<?php echo e($product->category->name ?? 'Clothing'); ?>"
                                        data-code="<?php echo e($product->code ?? '5100000001'); ?>"
                                        data-unit="<?php echo e($product->unit ?? 'Pcs'); ?>">
                                    Brand: <?php echo e($product->brand->name ?? 'Artisan'); ?> - Category: <?php echo e($product->category->name ?? 'Clothing'); ?> - <?php echo e($product->name); ?> - <?php echo e($product->unit ?? 'Pcs'); ?>
                ...
                <div class="d-flex justify-content-between mt-4">
                    ...
                    <a href="<?php echo e(route('purchases.index')); ?>" class="btn btn-danger-custom px-4">Cancel</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card card-custom p-3 shadow-sm">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="purchase_date" class="form-control" value="<?php echo e(date('Y-m-d')); ?>" required>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Downloads\supplier-purchase-app\supplier-purchase-app\resources\views/purchases/create.blade.php ENDPATH**/ ?>