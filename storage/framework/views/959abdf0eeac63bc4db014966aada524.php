                ...
                <ul class="navbar-nav align-items-center">
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-white" href="#" role="button" data-bs-toggle="dropdown">
                                <i class="fa fa-user-circle me-1"></i> <?php echo e(Auth::user()->name ?? 'Admin User'); ?>
                    ...
                    <?php else: ?>
                        ...
                        <?php if(Route::has('register')): ?>
                            <li class="nav-item">
                                <a href="<?php echo e(route('register')); ?>" class="btn btn-purple btn-sm">
...
</html><?php /**PATH C:\Users\USER\Downloads\supplier-purchase-app\supplier-purchase-app\resources\views/layouts/app.blade.php ENDPATH**/ ?>